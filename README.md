...
**Dataset:** `weather_dataset.csv` — contains numeric weather measurements.
...
- **Model Tuning** – hyperparameter optimization to improve R² performance.  
- **Model Evaluation** – using **R², MAE, MSE, RMSE** metrics.
